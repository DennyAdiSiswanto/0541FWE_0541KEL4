       ...
       <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="{{url('/')}}" class="navbar-brand">Sistem Informasi Pegawai</a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                        <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> pegawai <span class="caret"></span>
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dLabel">
                                ...
                                <li class="divider"></li>
                                <li><a href="{{url('kerja')}}">kerja</a></li>
                            </ul>
                    </li>
                    ...
                    <li class="dropdown active">
                        <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Dosen <span class="caret"></span>
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dLabel">
                                <li><a href="{{url('manager')}}">Data Dosen</a></li>
                                <li class="divider"></li>
                    ...
                    <li class="dropdown active">
                        <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Pengaturan <span class="caret"></span>
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dLabel">
                                <li><i class="fa fa-users"><a href="{{url('ruang')}}">ruang</i></a></li>
                                <li class="divider"></li>
                                <li><i class="fa fa-map"><a href="{{url('golongan')}}">golongan</i></a></li>
                                <li><i class="fa fa-cogs"><a href="{{url('cuti')}}">cuti</i></a></li>
                            </ul>
                    </li>
                </ul>
    ...
    <div class="col-md-4">
        <div class="panel panel-info text-center">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><a href="/pegawai" class="btn btn-primary"><i class="fa fa-user"></i> DATA pegawai</a></li>
            </ul>
        </div>
    </div>
    <div class="col-md-4">
        <div class="panel panel-info text-center">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><a href="/manager" class="btn btn-primary"><i class="fa fa-university"></i> DATA Manager</a></li>
            </ul>
        </div>
    </div>
